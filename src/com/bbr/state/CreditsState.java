...
public class CreditsState extends BbrGameState {
	...
	public CreditsState() throws SlickException {
		super(BlackbeardsRedemption.States.CREDITS.ordinal());
	...
	public void update(GameContainer gc, StateBasedGame sbg, int delta)
		...
		if(goingToExit) {
			sbg.enterState(BlackbeardsRedemption.States.MENU.ordinal());
			goingToExit = false;
			creditScreen = false;
		}
	}
